      ...
      <main className="py-20 px-4 sm:px-12 lg:px-28">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl relative sm:text-5xl font-extrabold text-blue-800 mb-4 font-poppins">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              ...
              sur le lavage, l'entretien et la sécurité. Chaque conseil est un
              pas de plus vers une conduite sereine et un véhicule impeccable.
            </p>
          </div>
